...
public class Générateur_Terrain : MonoBehaviour {
	...
	//	string pathTerrain3 = "Prefabs/Terrain"+Random.Range (1, 20);
		...
		GameObject g3 = Instantiate(Resources.Load("Prefabs/Terrain20"), new Vector2(g1.transform.position.x+26, g1.transform.position.y), Quaternion.identity) as GameObject;
	}
