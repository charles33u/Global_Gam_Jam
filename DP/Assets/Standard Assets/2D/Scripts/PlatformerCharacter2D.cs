...
using UnityEngine;
    ...
    public class PlatformerCharacter2D : MonoBehaviour
    {
        ...
        //CounterAttack
        public float stunCooldownCa = 1.2f;
        ...
        private bool CanIMove()
        {
            ...
            switch (lastAction)
            {
                ...
                case LastAction.Block:
                    return timer >= stunCooldownCa;
                case LastAction.Shoot:
        ...
        switch (lastAction)
            {
                case LastAction.Attack:
                    return timer >= actionCooldownAttack;
                case LastAction.Block:
                    return timer >= actionCooldownCa;
                case LastAction.Shoot:
                    return timer >= actionCooldownShoot;
                default:
                    return true;
            }
        }
